...
def get_da_base_training_parser(parser=None):
    ...
    parser.add_argument('src_dataset', type=str, choices=["gta", "city", "city16", "synthia", "sim_robot", "real_robot"])
    parser.add_argument('tgt_dataset', type=str, choices=["gta", "city", "city16", "synthia", "sim_robot", "real_robot"])
